...
import dataretrieval.wqp as dqwp
import requests
import io

# df_qwp = qwp.get_qwp(staid=433615110440001, startDateLo="01-01-2020", service="results", startDateHi="12-31-2020")
# response = requests.post(url="https://www.waterqualitydata.us/data/Result/search?", data={"siteid": ["USGS-433615110440001", "USGS-433641110441501"], "startDateLo": "01-01-2020", "startDateHi": "12-31-2020", "service": "results"})
# decoded = io.StringIO(response.content.decode('utf-8'))
# rawData = pd.read_csv(io.StringIO(response.content.decode('utf-8')))
# data = dqwp.get_results(siteid=433615110440001, startDateLo="01-01-2020", service="results", startDateHi="12-31-2020")

# df_nwis = nwis.get_record(sites=[433615110440001], service="qwdata", start="2020-01-01", end="2020-12-01", datetime_index=False)
